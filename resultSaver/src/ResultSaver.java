...
//        writer.print("Отвеченные вопросы: " + statisticsCurrentUser);
        ...
        int answered = 0;
        int numHard = 0;
        Map<String, QuestionStatistics> processedQuestions = new HashMap<String, QuestionStatistics>();
        ...
        for (AnsweringStatistic answeringStatistic : statisticsCurrentUser) {
            ...
            if (processedQuestions.containsKey(question.getMainText())) {
                QuestionStatistics questionStatistics = (QuestionStatistics) processedQuestions.get(question.getMainText());
                ...
                processedQuestions.put(question.getMainText(), questionStatistics);
            } else {
        ...
        if (question instanceof OpenQuestion) {
            ...
            new HibernateTestManager().executeCommand(new ICommand<Session>() {
                public Object execute(Session sessionManager) {
                    ...
                    List answers = sessionManager.createQuery("from ClosedAnswer as a where question_id = " + question.getId()).list();
                    for (Object closedAnswer : answers) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Iterator iterator = users.iterator(); iterator.hasNext();) {
            ...
            saver.saveToFile(user.getId(), writer, stat);
        }
